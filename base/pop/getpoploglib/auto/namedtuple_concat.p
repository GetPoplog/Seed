...
section $-namedtuple => namedtuple_concat;

define global constant procedure namedtuple_concat( d1, d2 );
    lvars ( d1keys, d1values, d1length ) = d1.destnamedtuple.dup.datalength;
    lvars ( d2keys, d2values, d2length ) = d2.destnamedtuple.dup.datalength;
    ...
    endwhile;
    consnamedtuple( keys.namedtuple_table, values );
enddefine;
